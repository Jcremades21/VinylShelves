...
export default function ChangePassScreen({ navigation, route }) {
    ...
    function compruebaCon(){
        const usuario = {
            ...
            nuevopassword: new1.value,
            nuevopassword2: new2.value
           }
           let urlu = Url + "/usuarios/np/" + UID;
           axios.put(urlu,
            usuario,
              {
                  headers: { 'Content-Type': 'application/json',
        ...
        <View style={styles.Fondo}>
            ...
            <View style={[
              {  paddingHorizontal: 20
                ...
                <Text style={styles.itemText3}>Current password</Text>
                <TextInputE value={oldPassword.value} secureTextEntry={true} onChangeText={(text) => setOldPassword({ value: text, error: '' })}></TextInputE>
                <Text style={styles.itemText3}>New password</Text>
                <TextInputE value={new1.value} secureTextEntry={true} onChangeText={(text) => setNew1({ value: text, error: '' })} ></TextInputE>
                <Text style={styles.itemText3}>Repeat new password</Text>
                <TextInputE value={new2.value} secureTextEntry={true} onChangeText={(text) => setNew2({ value: text, error: '' })} ></TextInputE>
                <Button onPress={compruebaCon} style={styles.buttonTrack} mode="contained">Save Changes</Button>
            </View>
            </ScrollView>
        </View>
    );
