...
export default function DeleteAccountScreen({ navigation, route }) {
    ...
    return (
        <View style={styles.Fondo}>
            ...
            <Text style={styles.itemText}>{makeid()}</Text>
            <Text style={styles.itemText3}>Type the verification code to delete your account</Text>
            <TextInputE value={code.value} onChangeText={(text) => setCode({ value: text, error: '' })}></TextInputE>
            <Button onPress={borraCuenta} mode="contained" style={styles.buttonTrack}>Delete</Button>
            </View>
